...
Logo na página inicial temos a tela padrão de Login e Senha, porém mais abaixo está uma frase clicável **`Esqueci a minha senha`**.
...
Agora, chegará um e-mail na caixa de entrada, e é necessário copiar o código de segurança que enviamos para seguir com a troca da senha.
