...
Nesta seção explicamos cada um dos itens agrupados no menu (Funcionalidades) e suas respectivas telas disponíveis na plataforma **Gestão Online**, e a melhor maneira de utilizar cada um. As funcionalidades estão dispostas no menu principal e é possível favoritar as que mais utiliza no menu de [`favoritos`](/erp-v2/primeiro_acesso/favoritos.md) para tê-las disponíveis sempre ao abrir a plataforma. Para saber mais sobre os itens do menu e suas funcionalidades, clique abaixo no de sua preferência:
