...
Após clicar no botão para adicionar um novo tipo de tributação, uma nova página será aberta e, ao lado direito da tela, é possível visualizar um pequeno menu cinza. Veja abaixo para entender melhor cada opção:
...
No momento do cadastro de uma nova tabela de indicação, será necessário preencher alguns campos obrigatórios que têm o asterisco vermelho. Eles são essenciais para o mínimo funcionamento no sistema.
...
Nos campos seguintes, temos a definição para esta tabela que estamos criando, no caso, vamos marcar como ativado o campo **Tipo Tabela de Comissão**, pois ela terá somente esta função para uso.
...
No primeiro item, esses valores são definidos por um valor fixo inserido na guia **Itens da tabela** que ficará disponível quando salvar esta tabela de indicação. É possível observar que na página não ocorre nenhuma alteração ou novos campos para editar.
...
Já o segundo item é para vincular a comissão a outra tabela de produtos/serviço existente. Lembrando que é preciso ter a tabela cadastrada para poder utilizá-la. Após defini-la, é necessário marcar o campo de computar percentual, e ao lado preencher o valor em porcentagem que será feito com base na origem/herança.
...
A plataforma junta essas tabelas e realiza a subtração para determinar o valor líquido da transação. Esse cálculo automatiza o processo para reduzir erros e aumentar a precisão dos dados. Tendo assim o valor da comissão como resultado.
...
Nesta guia, é possível adicionar, editar e remover produtos/serviços com a porcentagem/valor que será usada para calcular a comissão da venda.

![](/erp-v2/assets/funcionalidades/indicadores_afiliados/aba_tabela_indicacao_add_guia_itens.png)

Ao clicar em adicionar item, é necessário selecionar o [**`produto/serviço`**](/erp-v2/funcionalidades/produtos_servicos/README.md) já cadastrado na plataforma. Logo após, é definida a porcentagem que será utilizada para a comissão.
