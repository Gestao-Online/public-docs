...
Agora, no campo de **Descrição**, colocaremos o texto referente para podermos identificá-lo. Mas é possível usar a descrição que for mais conveniente para uso. Em nosso exemplo, utilizaremos o exemplo 1.05 - Licenciamento ou cessão de direito de uso de programas de computação.
