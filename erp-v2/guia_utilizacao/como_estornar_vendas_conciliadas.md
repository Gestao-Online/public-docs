...
{% hint style="info" %}
💡 **Observação:**
A opção de **estorno no canto superior da tela** refere-se a **vendas realizadas via PIX ou cartão**.
Para vendas realizadas por **boleto** ou **outras operações manuais**, é necessário abrir o **financeiro** e clicar na opção de **estorno diretamente** por lá.
{% endhint %}
