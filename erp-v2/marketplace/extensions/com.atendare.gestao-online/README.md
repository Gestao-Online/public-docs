...
O token da API Atendare é um código único necessário para conectar seu ERP Gestão Online ao CRM Atendare.

Para obter seu token, entre em contato com o suporte da Atendare abrindo um chamado diretamente pela sua conta. Após a solicitação, aguarde a resposta contendo o token.
