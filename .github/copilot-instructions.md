# Instruções de Estilo para Documentação - Gestão Online
...
1. **Alta prioridade:** Documentação voltada ao usuário final (erp-v2/, portal/)
2. **Média prioridade:** Documentação técnica (api/)
---
