...
* [🖥️ A plataforma (ERP)](erp-v2/README.md)
  ...
  * [📒 Guia de utilizaçāo](erp-v2/guia_utilizacao/README.md)
    * [Como configurar o sistema para emissão de notas fiscais de serviço (NFSe)](erp-v2/guia_utilizacao//.md)
    * [Como corrigir uma nota fiscal de serviço rejeitada (NFSe)?](erp-v2/guia_utilizacao//.md)
    * [A nota fiscal não foi emitida, como acompanhar (NFSe)? ](erp-v2/guia_utilizacao//.md)
    * [Como realizar um estorno de cartão de crédito ou PIX?](erp-v2/guia_utilizacao//.md)
    * [Como fazer o cancelamento em lote de vendas não concretizadas (não pagas)?](erp-v2/guia_utilizacao//.md)
    * [Já confirmei a venda/pedido e agora preciso alterar um item de produto e/ou serviço, como fazer?](erp-v2/guia_utilizacao//.md)
    * [Já confirmei a venda/pedido e agora preciso mudar o tipo de negociação (forma de pagamento), como fazer?](erp-v2/guia_utilizacao//.md)
    * [O que é a liberação de desconto, e como funciona?](erp-v2/guia_utilizacao//.md)
